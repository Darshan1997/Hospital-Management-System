<%@ Page Language="C#" AutoEventWireup="true" CodeFile="addmedicine.aspx.cs" Inherits="Hospital_management_system.addmedicine" %>
...
<br />
          ...
          <div class="row">
          <asp:Button runat="server"  style="margin-left:80px;"   OnClick="addmedicine1_Click" ID="addmedicine1" Text="Add Medicine"/>
          </div>
          
      
               
             </asp:Panel>
       <asp:PlaceHolder ID="final" runat="server"></asp:PlaceHolder> 
  </div>
