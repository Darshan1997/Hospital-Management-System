<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="modification_doctor.aspx.cs" Inherits="Hospital_management_system.modification_doctor" %>
  ...
  <div class="tab-content">
      ...
      <h3>General Details</h3>
          ...
          <div   class="form-group">
                    ...
                    <div style="margin-top:8px;"   class="col-sm-9">
                        <asp:Textbox  id="doc_id" runat="server"  placeholder="First Name" class="form-control" autofocus ReadOnly="True"></asp:Textbox>
                    </div>
                </div>
     <br />
    ...
    <div id="menu2"  style="max-width: 530px;margin:0px 0px 0px 25px"  class="tab-pane fade">
      <h3>Contact Details</h3>
        ...
        <asp:Panel ID="fordelete" runat="server">
